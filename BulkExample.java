...
public class BulkExample {
    ...
    public static void main(String[] args)
    		...
    		example.runSample("Contact", USERNAME, PASSWORD, "Contact_BulkAPI_Upsert_Sample.csv");
    }
	...
	*/
	private JobInfo createJob(String sobjectType, BulkConnection connection) throws AsyncApiException {
		...
		job.setExternalIdFieldName("ERP_Number_Id__c");
	...
	*/
	private BulkConnection getBulkConnection(String userName, String password) throws ConnectionException, AsyncApiException {
		...
		config.setAuthEndpoint("https://test.salesforce.com/services/Soap/c/41.0");
		...
		System.out.println("Rest Endpoint: " + config2.getRestEndpoint());
		
		// This should only be false when doing debugging.
		config2.setCompression(true);
		// Set this to true to see HTTP requests and responses on stdout
		config2.setTraceMessage(false);
		BulkConnection connection = new BulkConnection(config2);
		return connection;
	}
